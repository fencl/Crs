...
namespace Corrosive {
	...
	void ILBlock::dump() {
		...
		std::vector<std::uint8_t>::iterator it = data_pool.begin();
		std::size_t memoff = 0;
		while (it != data_pool.end()) {
			...
			switch (inst) {
				...
				case ILInstruction::fnptr: {
					std::cout << "   fnptr ";
					auto ind = ILBlock::read_data<std::uint32_t>(it);
				...
				case ILInstruction::table8roffset8: {
					...
					std::cout << (std::uint16_t)ILBlock::read_data<std::uint8_t>(it) << "):" << (std::uint16_t)ILBlock::read_data<std::uint8_t>(it) << "\n";
				} break;
				case ILInstruction::table8roffset16: {
					std::cout << "   tableroffset [";
					auto pair = ILBlock::read_data<ILDataTypePair>(it);
					dump_data_type(pair.first()); std::cout << "] -> ["; dump_data_type(pair.second()); std::cout << "] (table ";
					std::cout << (std::uint16_t)ILBlock::read_data<std::uint8_t>(it) << "):" << ILBlock::read_data<std::uint16_t>(it) << "\n";
				} break;
				case ILInstruction::table8roffset32: {
					std::cout << "   tableroffset [";
					auto pair = ILBlock::read_data<ILDataTypePair>(it);
					dump_data_type(pair.first()); std::cout << "] -> ["; dump_data_type(pair.second()); std::cout << "] (table ";
					std::cout << (std::uint16_t)ILBlock::read_data<std::uint8_t>(it) << "):" << ILBlock::read_data<std::uint32_t>(it) << "\n";
				} break;
				case ILInstruction::table16roffset8: {
					std::cout << "   tableroffset [";
					auto pair = ILBlock::read_data<ILDataTypePair>(it);
					dump_data_type(pair.first()); std::cout << "] -> ["; dump_data_type(pair.second()); std::cout << "] (table ";
					std::cout << ILBlock::read_data<std::uint16_t>(it) << "):" << (std::uint16_t)ILBlock::read_data<std::uint8_t>(it) << "\n";
				} break;
				case ILInstruction::table16roffset16: {
					std::cout << "   tableroffset [";
					auto pair = ILBlock::read_data<ILDataTypePair>(it);
					dump_data_type(pair.first()); std::cout << "] -> ["; dump_data_type(pair.second()); std::cout << "] (table ";
					std::cout << ILBlock::read_data<std::uint16_t>(it) << "):" << ILBlock::read_data<std::uint16_t>(it) << "\n";
				} break;
				case ILInstruction::table16roffset32: {
					std::cout << "   tableroffset [";
					auto pair = ILBlock::read_data<ILDataTypePair>(it);
					dump_data_type(pair.first()); std::cout << "] -> ["; dump_data_type(pair.second()); std::cout << "] (table ";
					std::cout << ILBlock::read_data<std::uint16_t>(it) << "):" << ILBlock::read_data<std::uint32_t>(it) << "\n";
				} break;
				case ILInstruction::table32roffset8: {
					std::cout << "   tableroffset [";
					auto pair = ILBlock::read_data<ILDataTypePair>(it);
					dump_data_type(pair.first()); std::cout << "] -> ["; dump_data_type(pair.second()); std::cout << "] (table ";
					std::cout << ILBlock::read_data<std::uint32_t>(it) << "):" << (std::uint16_t)ILBlock::read_data<std::uint8_t>(it) << "\n";
				} break;
				case ILInstruction::table32roffset16: {
					std::cout << "   tableroffset [";
					auto pair = ILBlock::read_data<ILDataTypePair>(it);
					dump_data_type(pair.first()); std::cout << "] -> ["; dump_data_type(pair.second()); std::cout << "] (table ";
					std::cout << ILBlock::read_data<std::uint32_t>(it) << "):" << ILBlock::read_data<std::uint16_t>(it) << "\n";
				} break;
				case ILInstruction::table32roffset32: {
					std::cout << "   tableroffset [";
					auto pair = ILBlock::read_data<ILDataTypePair>(it);
					dump_data_type(pair.first()); std::cout << "] -> ["; dump_data_type(pair.second()); std::cout << "] (table ";
					std::cout << ILBlock::read_data<std::uint32_t>(it) << "):" << ILBlock::read_data<std::uint32_t>(it) << "\n";
				} break;

				case ILInstruction::table8offset8: {
					std::cout << "   tableoffset (table " << (std::uint16_t)ILBlock::read_data<std::uint8_t>(it) << "): " << (std::uint16_t)ILBlock::read_data<std::uint8_t>(it) << "\n";
				} break;
				case ILInstruction::table8offset16: {
					std::cout << "   tableoffset (table " << (std::uint16_t)ILBlock::read_data<std::uint8_t>(it) << "): " << ILBlock::read_data<std::uint16_t>(it) << "\n";
				} break;
				case ILInstruction::table8offset32: {
					std::cout << "   tableoffset (table " << (std::uint16_t)ILBlock::read_data<std::uint8_t>(it) << "): " << ILBlock::read_data<std::uint32_t>(it) << "\n";
				} break;
				case ILInstruction::table16offset8: {
					std::cout << "   tableoffset (table " << ILBlock::read_data<std::uint16_t>(it) << "): " << (std::uint16_t)ILBlock::read_data<std::uint8_t>(it) << "\n";
				} break;
				case ILInstruction::table16offset16: {
					std::cout << "   tableoffset (table " << ILBlock::read_data<std::uint16_t>(it) << "): " << ILBlock::read_data<std::uint16_t>(it) << "\n";
				} break;
				case ILInstruction::table16offset32: {
					std::cout << "   tableoffset (table " << ILBlock::read_data<std::uint16_t>(it) << "): " << ILBlock::read_data<std::uint32_t>(it) << "\n";
				} break;
				case ILInstruction::table32offset8: {
					std::cout << "   tableoffset (table " << ILBlock::read_data<std::uint32_t>(it) << "): " << (std::uint16_t)ILBlock::read_data<std::uint8_t>(it) << "\n";
				} break;
				case ILInstruction::table32offset16: {
					std::cout << "   tableoffset (table " << ILBlock::read_data<std::uint32_t>(it) << "): " << ILBlock::read_data<std::uint16_t>(it) << "\n";
				} break;
				case ILInstruction::table32offset32: {
					std::cout << "   tableoffset (table " << ILBlock::read_data<std::uint32_t>(it) << "): " << ILBlock::read_data<std::uint32_t>(it) << "\n";
				} break;
				...
				case ILInstruction::clone: {
					std::cout << "   clone [";
					dump_data_type(ILBlock::read_data<ILDataType>(it));
					std::cout << "] " << ILBlock::read_data<std::uint16_t>(it) << "\n";
				} break;
				case ILInstruction::insintric: {
					std::cout << "   insintric \"";
					auto type = ILBlock::read_data<std::uint8_t>(it);
				...
				case ILInstruction::local8: {
					std::cout << "   local ";
					auto offset = ILBlock::read_data<std::uint8_t>(it);
					std::cout << (std::uint16_t)offset << "\n";
					break;
				}
				case ILInstruction::local16: {
					std::cout << "   local ";
					auto offset = ILBlock::read_data<std::uint16_t>(it);
					std::cout << offset << "\n";
					break;
				}
				case ILInstruction::local32: {
					std::cout << "   local ";
					auto offset = ILBlock::read_data<std::uint32_t>(it);
					std::cout << offset << "\n";
					break;
				}
				...
				case ILInstruction::offset32: {
					...
					auto off = ILBlock::read_data<std::uint32_t>(it);
				...
				case ILInstruction::offset16: {
					std::cout << "   offset ";
					auto t = ILBlock::read_data<ILSizeType>(it);
					auto off = ILBlock::read_data<std::uint16_t>(it);
					ILSize(t, off).print(parent->parent);
					std::cout << "\n";
					break;
				}
				case ILInstruction::offset8: {
					std::cout << "   offset ";
					auto t = ILBlock::read_data<ILSizeType>(it);
					auto off = ILBlock::read_data<std::uint8_t>(it);
					ILSize(t, off).print(parent->parent);
					std::cout << "\n";
					break;
				}
				case ILInstruction::aoffset8: {
					std::cout << "   aoffset " << (std::uint16_t)ILBlock::read_data<std::uint8_t>(it) << "\n";
					break;
				}
				case ILInstruction::aoffset16: {
					std::cout << "   aoffset " << ILBlock::read_data<std::uint16_t>(it) << "\n";
					break;
				}
				case ILInstruction::aoffset32: {
					std::cout << "   aoffset " << ILBlock::read_data<std::uint32_t>(it) << "\n";
					break;
				}
				case ILInstruction::woffset8: {
					std::cout << "   woffset " << (std::uint16_t)ILBlock::read_data<std::uint8_t>(it) << "\n";
					break;
				}
				case ILInstruction::woffset16: {
					std::cout << "   woffset " << ILBlock::read_data<std::uint16_t>(it) << "\n";
					break;
				}
				case ILInstruction::woffset32: {
					std::cout << "   woffset " << ILBlock::read_data<std::uint32_t>(it) << "\n";
					break;
				}
				...
				case ILInstruction::jmpz: {
					...
					std::cout << address << " : ";
					address = ILBlock::read_data<std::uint32_t>(it);
					std::cout << address << "\n";
					break;
				}
				...
				case ILInstruction::u8:  std::cout << "   u8 " << (std::uint16_t)ILBlock::read_data<std::uint8_t>(it) << "\n"; break;
				case ILInstruction::u16: std::cout << "   u16 " << ILBlock::read_data<std::uint16_t>(it) << "\n"; break;
				case ILInstruction::u32: std::cout << "   u32 " << ILBlock::read_data<std::uint32_t>(it) << "\n"; break;
				case ILInstruction::u64: std::cout << "   u64 " << ILBlock::read_data<std::uint64_t>(it) << "\n"; break;
				case ILInstruction::i8:  std::cout << "   i8 " << (std::int16_t)ILBlock::read_data<std::int8_t>(it) << "\n"; break;
				case ILInstruction::i16: std::cout << "   i16 " << ILBlock::read_data<std::int16_t>(it) << "\n"; break;
				case ILInstruction::i32: std::cout << "   i32 " << ILBlock::read_data<std::int32_t>(it) << "\n"; break;
				case ILInstruction::i64: std::cout << "   i64 " << ILBlock::read_data<std::int64_t>(it) << "\n"; break;
