...
namespace Corrosive {
	class Expression {
	public:
		static void parse(Cursor& c,RecognizedToken& tok, CompileValue& res, CompileType comp_type, bool require_output = true, Type* request = nullptr);
	...
	private:
		static void parse_and(Cursor& c, RecognizedToken& tok, CompileValue& res, CompileType comp_type, Type* request);
		static void parse_or(Cursor& c, RecognizedToken& tok, CompileValue& res, CompileType comp_type, Type* request);
		static void parse_operators(Cursor& c, RecognizedToken& tok, CompileValue& res, CompileType comp_type, Type* request);
