...
namespace Corrosive {
	class Expression {
	public:
		static void parse(Compiler& compiler, Cursor& c, CompileValue& res, CompileType comp_type, bool require_output = true);
	...
	private:
		static void parse_and(Compiler& compiler, Cursor& c, CompileValue& res, CompileType comp_type);
		static void parse_or(Compiler& compiler, Cursor& c, CompileValue& res, CompileType comp_type);
		static void parse_operators(Compiler& compiler, Cursor& c, CompileValue& res, CompileType comp_type);
