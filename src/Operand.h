...
namespace Corrosive {
	...
	class Operand {
	public:
		static void parse(Cursor& c, CompileValue& res, CompileType copm_type);
		...
		static void priv_type_template_cast(ILEvaluator* eva);
		...
		static void parse_reference(CompileValue& ret, Cursor& c, CompileType copm_type);
		static void parse_array_type(CompileValue& ret, Cursor& c, CompileType copm_type);
		static void parse_symbol(CompileValue& ret, Cursor& c, CompileType copm_type);
		...
		static void parse_call_operator(CompileValue& ret, Cursor& c, CompileType copm_type);
